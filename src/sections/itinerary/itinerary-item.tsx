...
export function ItineraryItem({ tour, onView, onEdit, onDelete }: Props) {
  ...
  const renderTexts = (
    <ListItemText
      ...
      primary={`Created on ${fDateTime(tour.createdAt)}`}
      secondary={
        <Link component={RouterLink} href={paths.app.tourPlan.details(tour.id)} color="inherit">
          {tour.name}
        </Link>
      }
